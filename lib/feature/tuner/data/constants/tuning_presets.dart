...
class TuningPresets {
  static const standardTuning = TuningModel(
    name: 'Standard E',
    notes: [
      NoteModel(name: 'E4', frequency: 82.41),
      NoteModel(name: 'A4', frequency: 110.00),
      NoteModel(name: 'D4', frequency: 146.83),
      NoteModel(name: 'G4', frequency: 196.00),
      NoteModel(name: 'B4', frequency: 246.94),
  ...
  static const dropDTuning = TuningModel(
    name: 'Drop D',
    notes: [
      NoteModel(name: 'D4', frequency: 73.42),
      NoteModel(name: 'A4', frequency: 110.00),
      NoteModel(name: 'D4', frequency: 146.83),
      NoteModel(name: 'G4', frequency: 196.00),
      NoteModel(name: 'B4', frequency: 246.94),
